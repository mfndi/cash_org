...
if(isset($_POST['submit'])){
    if($kas_masuk->add_uangkas($_POST) > 0){
...
<!--                                     <div class="text-center">
                                    ...
                                    <form class="user" method="post" action="">
                                        ...
                                        <div class="form-group">
                                            <input type="number" class="form-control" placeholder="Masukan Nominal" name="nominal_cash">
                                        </div>
                                        <div class="form-group">
                                            <input type="date" class="form-control" name="tgl_kas">
                                        </div>
                                        <div class="mb-3">
                                              <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="catatan" placeholder="Catatan, contoh : Bayar Cash."></textarea>
                                        </div>
                                        <div class="form-group">
