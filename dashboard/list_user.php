...
$result = $db->prepare("SELECT * FROM cash_user");
$result->execute();
...
$tampil = $db->prepare("SELECT * FROM cash_user ORDER BY id DESC LIMIT $awaldata , $jumlahDataPerhalaman");
$tampil->execute();
$ini_user = $tampil->fetchAll();
                            ...
                            <div class="table-responsive d-flex">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <thead>
                                     ...
                                     <?php foreach ($ini_user as $all_user) : ?>
                                    <tbody>
                                        <tr>
                                            <td><?php echo $no; ?></td>
                                            <td><?php echo $all_user['nama_awal']; ?> <?php echo $all_user['nama_akhir']; ?></td>
                                            <td><?php echo $all_user['email']; ?></td>
                                            <td><?php echo $all_user['level_user']; ?></td>
                                            <td>&nbsp;<a href="edit_user.php?user=<?php echo $all_user['code_uniq']; ?>"><button type="button" class="btn btn-success">Edit</button></a> 
                                                &nbsp; <a href="hapus_data.php?user=<?php echo $all_user['code_uniq']; ?>"><button type="button" class="btn btn-danger" onclick="return confirm('Apakah Anda Yakin?')">Hapus</button></a>
                                                &nbsp;
                                            </td>
                                        </tr>
                                    </tbody>
