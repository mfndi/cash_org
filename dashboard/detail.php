...
if(isset($_GET['num']) && !empty($_GET['num'])){
    $id_detail = $_GET['num'];
    $db = database::connect();
    $detail = $db->prepare("SELECT * FROM cash_anggota WHERE code_uniq = :id_detail");
    $detail->bindParam(":id_detail", $id_detail);
    $detail->execute();
        if($detail->rowCount() === 1){
             $info_anggota = $detail->fetch(PDO::FETCH_ASSOC);
                    $nama_anggota = $info_anggota['nama_anggota'];
                    $tgl_lahir = $info_anggota['tgl_lahir'];
                    $ponsel_anggota = $info_anggota['ponsel_anggota'];
                    $email_anggota = $info_anggota['email_anggota'];
                    $alamat_anggota = $info_anggota['alamat_anggota'];
        }
        else{
                                    ...
                                    <form class="user" method="post" action="">
                                        <div class="form-group">
                                            <input class="form-control"
                                                ...
                                                placeholder="Nama" value="<?php echo $nama_anggota; ?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <input class="form-control" value="<?php echo $tgl_lahir; ?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <input class="form-control"
                                                id="exampleInputEmail" aria-describedby="emailHelp"
                                                placeholder="Nomer Telpon" value=" <?php echo "+62" . $ponsel_anggota; ?>" readonly>
                                        </div>
                                         <div class="form-group">
                                            <input type="email" class="form-control"
                                                id="exampleInputEmail" aria-describedby="emailHelp"
                                                placeholder="Email" value="<?php echo $email_anggota; ?>" readonly>
                                        </div>
                                        <div class="mb-3">
                                              <label for="exampleFormControlTextarea1" class="form-label">Alamat Lengkap</label>
                                              <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" readonly><?php echo $alamat_anggota; ?></textarea>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <a href="daftar_anggota.php"><button type="button" class="btn btn-primary btn-user btn-block">Back</button></a>
                                    </form>
                                    <hr>
                                </div>
                                </div>
