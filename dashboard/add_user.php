...
$con_user = new Config_User();



if(isset($_POST['submit'])){
    if($con_user->add_user($_POST) > 0){
...
<!--                                     <div class="text-center">
                                    ...
                                    <form class="user" method="post" action="">
                                        <input type="hidden" name="code" value="<?php echo bin2hex(random_bytes(16)); ?>">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="First Name" name="nama_awal" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Last Name" name="nama_akhir" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control" placeholder="Konfirmasi Password" name="passwd_konfirmasi" required>
                                        </div>
                                        <div class="form-group">
