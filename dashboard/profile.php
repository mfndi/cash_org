                                ...
                                <div class="card-body">
                                    ...
                                    <form class="user" method="post" action="">
                                        <div class="form-group">
                                            <input type="text" class="form-control" value="<?php echo $data['nama_awal']; ?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control"  value="<?php echo $data['nama_akhir']; ?>" readonly>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <a href="index.php"><button type="button" class="btn btn-primary btn-user btn-block">Back</button></a>
                                    </form>
                                    <hr>
                                </div>
                                </div>
