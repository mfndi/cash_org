...
$update_anggota = new Config_anggota();
...
if(isset($_GET['num']) && !empty($_GET['num'])){
        $id_data = $_GET['num'];
        $db = database::connect();
        $query = $db->prepare("SELECT * FROM cash_anggota WHERE code_uniq = :id_data");
        $query->bindParam(":id_data", $id_data);
        $query->execute();
            if($query->rowCount() === 1){
                $data_anggota = $query->fetch(PDO::FETCH_ASSOC);
                    $id_anggota = $data_anggota['id_anggota'];
                    $nama_anggota = $data_anggota['nama_anggota'];
                    $ponsel_anggota = $data_anggota['ponsel_anggota'];
                    $tgl_lahir = $data_anggota['tgl_lahir'];
                    $alamat_anggota = $data_anggota['alamat_anggota'];
                    $email_anggota = $data_anggota['email_anggota'];
                    $code = $data_anggota['code_uniq'];
            }else{
...
if(isset($_POST['submit'])){
    if($update_anggota->edit_anggota($_POST) > 0){
        echo "<script>
                    alert('Sukses!');
...
<!--                                     <div class="text-center">
                                    ...
                                    <form class="user" method="post" action="">
                                        <div>
                                            <input type="hidden" name="id_data" value="<?php echo $code; ?>">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control"
                                                id="exampleInputEmail" aria-describedby="emailHelp" value="<?php echo $nama_anggota; ?>" name="nama_anggota">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input type="number" class="form-control"
                                                ...
                                                placeholder="Nomer Telpon" value="<?php echo $ponsel_anggota ?>" name="ponsel_anggota">
                                        </div>
                                         <div class="form-group">
                                            <input type="email" class="form-control"
                                                id="exampleInputEmail" aria-describedby="emailHelp"
                                                placeholder="Email" value="<?php echo $email_anggota; ?>" name="email_anggota">
                                        </div>
                                        <div class="mb-3">
                                              <label for="exampleFormControlTextarea1" class="form-label">Alamat Lengkap</label>
                                              <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="alamat_anggota"><?php echo $alamat_anggota; ?></textarea>
                                        </div>
                                        <div class="form-group">
