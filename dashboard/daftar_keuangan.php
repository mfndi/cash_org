...
$result = $db->prepare("SELECT * FROM cash_masuk");
$result->execute();
...
$tampil_data = $db->prepare("SELECT * FROM cash_masuk ORDER BY id DESC LIMIT $awaldata, $jumlahDataPerhalaman");
$tampil_data->execute();
$daftar_uangkas = $tampil_data->fetchAll();
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive d-flex">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php foreach ($daftar_uangkas as $kas) : ?>
                                    <tbody>
                                        <tr>
                                            <td><?php echo $no; ?></td>
                                            <td><?php echo $kas['bayar_anggota']; ?></td>
                                            <td><?php echo $kas['nominal_cash']; ?></td>
                                            <td><?php echo $kas['tgl_masuk']; ?></td>
                                            <td><?php echo $kas['ket_pembayaran']; ?></td>
                                            <td>&nbsp;<a href="edit_kas.php?num=<?php echo $kas['code_uniq']; ?>"><button type="button" class="btn btn-success">Edit</button></a>
                                                &nbsp; <a href="hapus_data.php?code_keuangan=<?php echo $kas['code_uniq']; ?>"><button type="button" class="btn btn-danger" onclick="return confirm('Apakah Anda Yakin?')">Hapus</button></a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <?php $no++; ?>
