...
if(isset($_GET['user']) && !empty($_GET['user'])){
    $db = database::connect();
    $data = $_GET['user'];
    $query_data = $db->prepare("SELECT * FROM cash_user WHERE code_uniq = :id");
    $query_data->bindParam(":id", $data);
    $query_data->execute();
        if($query_data->rowCount() == 1){
            $isi_data = $query_data->fetch(PDO::FETCH_ASSOC);
                $nama_awal = $isi_data['nama_awal'];
                $id = $isi_data['code_uniq'];
                                    ...
                                    <form class="user" method="post" action="">
                                        <input type="hidden" name="id" value="<?php echo $id; ?>">
                                         <div class="form-group">
                                            <input type="password" class="form-control" placeholder="Masukan Password Lama" name="passwd_old">
                                        </div> 
                                        <div class="form-group">
                                            <input type="password" class="form-control" placeholder="Masukan Password Baru" name="passwd_awal">
                                        </div>
                                        <div class="form-group">
                                            <input type="password" class="form-control" placeholder="Ulangi Password" name="passwd_konfirmasi">
                                        </div>
                                        <div class="form-group">
