...
// $data_pengularan = new Config_uangkas();
// $pengeluaran = $data_pengularan->view_catatan();
error_reporting(0);
$db = database::connect();
$jumlahDataPerhalaman = 5;
$query = $db->prepare("SELECT * FROM cash_catatan");
$query->execute();
$jumlahData = $query->rowCount();
$jumlahHalama = ceil($jumlahData / $jumlahDataPerhalaman);
...
$tampil_data = $db->prepare("SELECT * FROM cash_catatan ORDER BY id DESC LIMIT $awaldata, $jumlahDataPerhalaman");
$tampil_data->execute();
$pengeluaran = $tampil_data->fetchAll();
                   ...
                   <div class="card shadow mb-5">
                        ...
                        <div class="card-body">
                             ...
                             <div class="col-md-2  mt-4">
                                ...
                                <a href="export_catatan.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mt-1"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>
                             </div>

                             <div class="col-md-8 mt-5 ">
                               <form class="form-inline my-2 my-lg-0" action="search_pengeluaran.php" method="get" name='cari'>
                            ...
                            <div class="table-responsive d-flex">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php foreach ($pengeluaran as $data_catatan) : ?>
                                    <tbody>
                                        <tr>
                                            <td><?php echo $no; ?></td>
                                            <td><?php echo $data_catatan['catatan']; ?></td>
                                            <td><?php echo $data_catatan['nominal_uang']; ?></td>
                                            <td><?php echo $data_catatan['tanggal']; ?></td>
                                            <td>&nbsp;<a href="edit_pengeluaran.php?catatan=<?php echo $data_catatan['code_uniq']; ?>"><button type="button" class="btn btn-success">Edit</button></a>
                                                &nbsp; <a href="hapus_data.php?catatan=<?php echo $data_catatan['code_uniq'];  ?>"><button type="button" class="btn btn-danger" onclick="return confirm('Apakah Anda Yakin?')">Hapus</button></a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <?php $no++; ?>
                            ...
                            <!-- navigasi -->
                                ...
                                <?php endfor; ?>
                            <!-- end navigasi -->
                            <?php if($halamanAktif < $jumlahHalama) : ?>
                                <a href="?p=<?php echo $halamanAktif + 1 ?>">&gt;</a>
                            <?php else :?>
                            <?php endif; ?>
                        </div>
