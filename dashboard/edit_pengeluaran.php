...
if(isset($_GET['catatan']) && !empty($_GET['catatan'])){
    $id_data = $_GET['catatan'];
    $db = database::connect();
        $query = $db->prepare("SELECT * FROM cash_catatan WHERE code_uniq = :id_data");
...
if(isset($_POST['submit'])){
    if($catatan_update->update_catatan($_POST) > 0){
...
<!--                                     <div class="text-center">
                                    ...
                                    <form class="user" method="post" action="">
                                        ...
                                        <div class="form-group">
                                            <input type="number" class="form-control" name="nominal" value="<?php echo $nominal; ?>">
                                        </div>
