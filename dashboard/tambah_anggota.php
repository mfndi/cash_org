...
$add = new Config_anggota();


if(isset($_POST['submit'])){
    if($add->tambah_anggota($_POST) > 0){
                                    ...
                                    <form class="user" method="post" action="">
                                        <div class="form-group">
                                            <input type="text" class="form-control"
                                                ...
                                                placeholder="Nama" name="nama_anggota">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                          ...
                                          <input type="number" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="ponsel_anggota">
                                        </div>
                                         <div class="form-group">
                                            <input type="email" class="form-control"
                                                id="exampleInputEmail" aria-describedby="emailHelp"
                                                placeholder="Email" name="email_anggota">
                                        </div>
                                        <div class="mb-3">
                                              <label for="exampleFormControlTextarea1" class="form-label">Alamat Lengkap</label>
                                              <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="alamat_anggota"></textarea>
                                        </div>
                                        <div class="form-group">
